...
exports.showIndicator = function(_messageString){
	...
	activityIndicator = Ti.UI.createActivityIndicator({
		style : OS_IOS ? Ti.UI.iphone.ActivityIndicatorStyle.Dark : TiUI.ActivityIndicatorStyle.Dark,
		top: "10dp",
		right: '30dp',
		bottom: '10dp',
		left: "30dp",
	...
	// safety catch all to ensure the screen eventually clears after 25 seconds
